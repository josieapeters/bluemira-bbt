...
@app.cell
def _(Parameter, ParameterFrame, dataclass):
    @dataclass
    ...
    return PlasmaDesignerParams, TFCoilBuilderParams
...
def _(
    ...
    return PlasmaBuilder, PlasmaDesigner
...
def _(
    ...
    return TFCoilBuilder, TFCoilDesigner
...
@app.cell
def _(EmptyFrame, ReactorConfig, build_config):
...
@app.cell
def _(Plasma, PlasmaBuilder, PlasmaDesigner, reactor_config):
...
@app.cell
def _(TFCoil, TFCoilBuilder, TFCoilDesigner, plasma, reactor_config):
...
@app.cell
def _(MyReactor, plasma, tf_coil):
